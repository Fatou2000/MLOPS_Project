...
with col2:
    ...
    st.image(logo, width=100)  # Ajustez la largeur selon vos préférences
...
if uploaded_file is not None:
    ...
    with col2:
        st.write("## 🏷️ Classification en cours...")
    ...
    if st.button('🗑️ Effacer et charger une nouvelle image'):
